...
// Function SQL with updated schema
const sql = `
...
// Write to file
fs.writeFileSync(path.join(__dirname, 'function-v2.sql'), sql);
console.log('Function SQL written to function-v2.sql');
console.log('\nTo apply the function:');
console.log('1. Go to https://supabase.com/dashboard/project/nrfpsbbkynykubcaarpg/sql/new');
console.log('2. Copy and paste the contents of scripts/function-v2.sql');
console.log('3. Click "Run" to create the function');

// Copy to clipboard
require('child_process').execSync(`cat "${path.join(__dirname, 'function-v2.sql')}" | pbcopy`);
