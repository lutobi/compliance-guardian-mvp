...
async function testOnboardingFlow() {
  ...
  try {
    ...
    // Wait for workspace setup step to load
    ...
    await page.waitForSelector('#industry', { timeout: 10000 });
    await page.waitForSelector('#companySize', { timeout: 10000 });
