...
// Write to file
fs.writeFileSync(path.join(__dirname, 'function-v3.sql'), sql);
console.log('Function SQL written to function-v3.sql');
console.log('\nTo fix the function:');
console.log('1. Go to https://supabase.com/dashboard/project/nrfpsbbkynykubcaarpg/sql/new');
console.log('2. Copy and paste the contents of scripts/function-v3.sql');
console.log('3. Click "Run" to create and test the function');

// Copy to clipboard
require('child_process').execSync(`cat "${path.join(__dirname, 'function-v3.sql')}" | pbcopy`);
