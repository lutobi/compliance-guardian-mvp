...
async function testOnboardingFlow() {
  ...
  try {
    ...
    await page.evaluate(() => {
      ...
      cards[0].click(); // First card is "Create New Workspace"
    });
    await page.click('button:not([variant="outline"])'); // Click Continue
    console.log('✅ Selected Create New Workspace');

    // Fill workspace setup form
    ...
    await page.click('button:not([variant="outline"])'); // Click Create Workspace
