...
async function testOnboardingFlow() {
  ...
  try {
    ...
    // Add state tracking for button click
    await page.evaluate(() => {
    ...
    await page.waitForFunction(() => {
      return window.__buttonClicked && window.__nextStepLoaded;
    }, { timeout: 10000 });
    ...
    // Wait for both the submission and the next step to load
    await page.waitForFunction(() => {
      return window.__workspaceSubmitted && window.__profileFormLoaded;
    }, { timeout: 15000 });
