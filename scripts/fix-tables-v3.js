...
// Complete table schema SQL with CASCADE option
const sql = `
...
// Write to file
fs.writeFileSync(path.join(__dirname, 'tables-v3.sql'), sql);
console.log('Table SQL written to tables-v3.sql');
console.log('\nTo apply the tables:');
console.log('1. Go to https://supabase.com/dashboard/project/nrfpsbbkynykubcaarpg/sql/new');
console.log('2. Copy and paste the contents of scripts/tables-v3.sql');
console.log('3. Click "Run" to recreate the tables and policies');

// Copy to clipboard
require('child_process').execSync(`cat "${path.join(__dirname, 'tables-v3.sql')}" | pbcopy`);
