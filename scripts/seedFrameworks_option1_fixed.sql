-- Fixed Option 1: Upsert by (name, version) to handle duplicate framework names

-- 0) Add unique constraint on (name, version)
ALTER TABLE public.frameworks
  ADD CONSTRAINT frameworks_name_version_unique UNIQUE (name, version);
...
-- 1) Upsert frameworks (omit id, use (name, version) unique)
...
-- 2) Upsert controls (by framework name + version lookup)
INSERT INTO public.controls (framework_id, name, description)
VALUES
  ((SELECT id FROM public.frameworks WHERE name='CSA STAR' AND version='4.0'), 'Application & Interface Security', 'Controls for app security & interfaces'),
  ((SELECT id FROM public.frameworks WHERE name='CSA STAR' AND version='4.0'), 'Audit Assurance & Compliance', 'Controls for audit & compliance'),
  ((SELECT id FROM public.frameworks WHERE name='CSA STAR' AND version='4.0'), 'Business Continuity Management', 'Controls for business continuity'),
  ((SELECT id FROM public.frameworks WHERE name='ISO 27017' AND version='2015'), 'Cloud Service Provider Controls', 'Provider-specific controls'),
  ((SELECT id FROM public.frameworks WHERE name='ISO 27017' AND version='2015'), 'Cloud Customer Controls', 'Customer-specific controls'),
  ((SELECT id FROM public.frameworks WHERE name='ISO 27017' AND version='2015'), 'Shared Controls', 'Controls shared provider/customer'),
  ((SELECT id FROM public.frameworks WHERE name='ISO 27018' AND version='2019'), 'Consent and Choice', 'Controls for consent management'),
  ((SELECT id FROM public.frameworks WHERE name='ISO 27018' AND version='2019'), 'Purpose Legitimacy', 'Controls for legitimate purposes'),
  ((SELECT id FROM public.frameworks WHERE name='ISO 27018' AND version='2019'), 'Data Minimization', 'Controls for data minimization'),
  ((SELECT id FROM public.frameworks WHERE name='ISO/IEC 27001' AND version='2022'), 'A.5 Information Security Policies', 'Management direction for info security'),
  ((SELECT id FROM public.frameworks WHERE name='ISO/IEC 27001' AND version='2022'), 'A.6 Organization of Info Security', 'Org structure & teleworking'),
  ((SELECT id FROM public.frameworks WHERE name='ISO/IEC 27001' AND version='2022'), 'A.7 Human Resource Security', 'Security for employees & contractors'),
  ((SELECT id FROM public.frameworks WHERE name='ISO/IEC 27001' AND version='2022'), 'A.8 Asset Management', 'Identify & protect assets')
