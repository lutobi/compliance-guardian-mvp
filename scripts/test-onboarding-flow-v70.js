...
// Create mock token with service role key
const mockToken = serviceKey;
...
async function testOnboardingFlow() {
  ...
  try {
    ...
    // Set up auth state
    await page.evaluate(async ({ token, userId, email }) => {
    ...
    }, { token: mockToken, userId: testUserId, email: testEmail });
