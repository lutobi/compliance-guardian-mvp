...
export const metadata: Metadata = {
  title: `${gdprLearning.name} - Learning Hub`,
  description: gdprLearning.overview.description,
};

export default function GDPRLearning() {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {/* Header */}
      <div className="mb-12">
        <h1 className="text-4xl font-bold mb-4">{gdprLearning.name}</h1>
        <p className="text-xl text-gray-600 max-w-4xl">
          {gdprLearning.overview.description}
        </p>
      </div>
      ...
      <CollapsibleSection title="Overview" defaultOpen={true} id="overview">
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            ...
            <p className="text-gray-600 mb-4">{gdprLearning.overview.importance}</p>
            <h4 className="font-semibold mb-2">Who Needs to Comply?</h4>
            <ul className="list-disc list-inside text-gray-600 space-y-2">
              {gdprLearning.overview.applicability.map((item, index) => (
          ...
          <div>
            ...
            <ul className="space-y-3">
              {gdprLearning.overview.benefits.map((benefit, index) => (
      ...
      <CollapsibleSection title="Key Components" id="components">
        <div className="grid md:grid-cols-3 gap-6">
          {gdprLearning.keyComponents.map((component, index) => (
      ...
      <CollapsibleSection title="Implementation Guide" id="implementation">
        <div className="space-y-6">
          {gdprLearning.implementation?.steps?.map((step, index) => (
            <div key={index} className="bg-gray-50 rounded-lg p-6">
      ...
      <CollapsibleSection title="Common Challenges" id="challenges">
        <div className="grid md:grid-cols-2 gap-6">
          {gdprLearning.implementation?.commonChallenges?.map((item, index) => (
            <div key={index} className="bg-gray-50 rounded-lg p-6">
      ...
      <CollapsibleSection title="Controls & Implementation" id="controls">
        {gdprLearning.controls.map((control, index) => (
      ...
      <section id="resources" className="mb-12">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="font-semibold mb-4">Governing Body</h3>
          <div className="mb-6">
            <p className="text-gray-600 mb-4">{gdprLearning.governingBody.description}</p>
            <a
              href={gdprLearning.governingBody.website}
              target="_blank"
          ...
          <h3 className="font-semibold mb-4">Official Resources</h3>
          <div className="grid md:grid-cols-2 gap-6">
            {gdprLearning.governingBody.resources.map((resource, index) => (
      ...
      <section id="faq" className="mb-12">
        ...
        <div className="bg-white rounded-lg shadow">
          {gdprLearning.faqs.map((faq, index) => (
