-- Apply workspace functions with corrected parameter names and table references
-- This script can be run directly in the Supabase SQL editor

-- Function to create a new workspace with owner (CORRECTED VERSION)
...
GRANT EXECUTE ON FUNCTION create_workspace_with_owner(UUID, TEXT, TEXT, TEXT, TEXT, TEXT) TO authenticated;